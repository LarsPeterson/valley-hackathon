...
const wasPasswordComprimised = function (password, callback) {
...
let encryptedPassword = encryptPassword(passwordToCheck).substr(0, 5).toUpperCase();
wasPasswordComprimised(encryptedPassword, (passwordMatches) => {
